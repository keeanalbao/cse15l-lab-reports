...
* Then, to use ssh, open a terminal in Visual Studio Code. (Ctrl + `, or use the Terminal → New Terminal menu option). Your command should look like this: `$ ssh cs15lsp23zz@ieng6.ucsd.edu`
